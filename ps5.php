...
<head>
    ...
    <title>Bandit's Shop :: PlayStation® 5</title>
...
<body>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown active">
                    ...
                    <div class="dropdown-menu">
                        <a href="ps5.php" class="dropdown-item active">PlayStation 5</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
            <br><br><br><br><br>
                <h1 class="text-center">PlayStation® 5</h1>
            </div>
            <div class="col-md-12">
                <br>
                <video src="recursos/ps5.mp4" controls autoplay muted  width="1130" height="590"></video>
                <br><br>
                <h3 class="text-center"><b> “Sé increíble, sorpréndete, sé PlayStation”. </b></h3>
            </div>
        </div>
        <br><br><br>
        <div class="card border-success">
            ...
            <div class="card-body">
                <table class="table">
                    ...
                    $sql = "select imagen,idproducto,descripcion,precio from productos where idcategoria='001' order by idproducto";
                    ...
                    while($fila = mysqli_fetch_row($rs)){
                        ...
                        "<br>".$fila[2]."<br>S/ ".$fila[3]."<br><br><a href=detalle_ps5.php?id=".$fila[1]."&pp=".$fila[3]." class='btn btn-success'>Ver Detalles</a></td>";
                        if($linea > 2){
                            echo "<tr>";
                            $linea = 1;
                        }else{
