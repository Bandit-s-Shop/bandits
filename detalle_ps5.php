...
<head>
    ...
    <title>Bandit's Shop :: Detalle :: PlayStation® 5</title>
            ...
            <div class="card-body">
                <table class="table">
                    ...
                    while($fila = mysqli_fetch_row($rs)){
                        echo "<td align=center><img src=".$fila[0]." width=500 height=500></td><td><br><p class='text-primary'>P l a yㅤ S t a t i o nㅤ 5
