...
<body>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown active">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a href="accesorios.php" class="dropdown-item active">Accesorios</a>
                    </div>
                </li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
            <br><br><br><br>
            <p class="text-primary">R e s i d e n tㅤ E v i lㅤ V i l l a g e</p>
                <br>
                <h1>Ahora S/ 300.00</h1>
                <br>
                <p>Resident Evil Village es la octava entrega numerada, ubicada unos años después de los eventos que sucedieron en Resident Evil 7, con una nueva trama con Ethan Winters y su mujer Mia viviendo pacíficamente en una nueva localización, libres de las pesadillas del pasado. Aunque la tragedia volverá a a impactar en ellos una vez más.</p>
                <br>
                <a 
                <?php
                    echo " href=videojuegos_detalle_ps5.php?id=00048&pp=300.00 ";
                ?>
                class="btn btn-info">tienda</a>
            </div>
            <div class="col-md-8">
                <video src="recursos/REV.mp4" controls muted autoplay width="840" height="570"></video>
            </div>
        </div>
        <br><br><br>
        <div class="card border-info">
            ...
            <div class="card-body">
                <table class="table">
                    ...
                    $sql = "select imagen,idproducto,descripcion,precio from productos where idcategoria='003' order by idproducto";
                    ...
                    while($fila = mysqli_fetch_row($rs)){
                        ...
                        "<br>".$fila[2]."<br>S/ ".$fila[3]."<br><br><a href=detalle_accesorios.php?id=".$fila[1]."&pp=".$fila[3]." class='btn btn-success'>Ver Detalles</a></td>";
                        if($linea > 2){
                            echo "<tr>";
                            $linea = 1;
                        }else{
