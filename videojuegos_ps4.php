...
<head>
    ...
    <title>Bandit's Shop :: Videojuegos Ps4</title>
...
<body>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown active">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a href="videojuegos_ps4.php" class="dropdown-item active">Videojuegos de PS4</a>
                    </div>
                </li>
                <li class="nav-item">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                <video src="recursos/videojuegops4.mp4" controls autoplay muted  width="849" height="590"></video>
            </div>
        </div>
        <br><br><br>
        <div class="card border-success">
            ...
            <div class="card-body">
                <table class="table">
                    ...
                    $sql = "select imagen,idproducto,descripcion,precio from productos where idcategoria='005' order by idproducto";
                    ...
                    while($fila = mysqli_fetch_row($rs)){
                        ...
                        "<br>".$fila[2]."<br>S/ ".$fila[3]."<br><br><a href=videojuegos_detalle_ps4.php?id=".$fila[1]."&pp=".$fila[3]." class='btn btn-success'>Ver Detalles</a></td>";
                        if($linea > 2){
                            echo "<tr>";
                            $linea = 1;
                        }else{
